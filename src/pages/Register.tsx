      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-soft-lg p-8 border border-slate-100 dark:border-slate-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full bg-purple-600 hover:bg-purple-700 text-white shadow-purple hover:shadow-purple-lg transition-all"
          ...
          <p className="text-center mt-6 text-slate-600 dark:text-slate-400">
            لديك حساب بالفعل؟{' '}
            <button onClick={() => navigate('login')} className="text-purple-600 hover:text-purple-700 dark:text-purple-400 font-medium">
              سجل دخولك
            </button>
          </p>
        </div>
